...
export default function AureviaLuxe() {
  ...
  // Define serverurl (Ensure this matches your environment)
  let {serverurl} = React.useContext(AuthContext).value;
  ...
  useEffect(() => {
    const handler = (e) => { if (e.key === "Enter") handleLoginLogic(); };
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .or-divider span { font-size: 11px; letter-spacing: 0.1em; color: #c5bfb5; text-transform: uppercase; }
        .social-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
        .btn-social { display: flex; align-items: center; justify-content: center; gap: 9px; padding: 12px; background: transparent; border: 1.5px solid var(--border); font-size: 13px; color: var(--charcoal); cursor: pointer; }
      ...
      <div className="luxe-wrapper">
        <div className="panel-left">
          ...
          <div className="brand-name">Aurevia<span>.</span></div>

          <div className="content-col">
            <span className="hero-eyebrow">Artisanal Nomad</span>
            <h1>Bohemian<br/>Rhapsody Redux</h1>
            <p>
              This theme explores innovative fabrics, futuristic designs, and sleek silhouettes 
              inspired by the digital age. A fusion of style and functionality for the modern minimalist.
            </p>
          ...
          <div className="image-display">
            <div className="img-main">
              <img src="https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800" className="display-img" alt="Fashion" />
            </div>
            <div className="img-overlap">
              <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80&w=600" className="display-img" alt="Details" />
            </div>
          </div>
        </div>
          ...
          <div className="form-container">
            ...
            <div>
              <div className="field">
                ...
                />
                {emailError && <div style={{fontSize:'11.5px', color:'var(--error)', marginTop:'5px'}}>Please enter a valid email.</div>}
              </div>
              ...
              <div className="field">
                ...
                {pwdError && <div style={{fontSize:'11.5px', color:'var(--error)', marginTop:'5px'}}>Password must be at least 8 characters.</div>}
              </div>
              ...
              <div className="options-row">
                ...
                <a href="#" style={{fontSize:'13px', color:'var(--muted)', textDecoration:'none'}}>Forgot password?</a>
              </div>

              <button 
  className={`btn-primary ${loading ? "loading" : ""}`} // Added space before "loading"
  type="button" 
...
>
  <span>{loading ? "Verifying..." : "Sign In"}</span>
              ...
              <div className="social-row">
                <button className="btn-social" type="button" onClick={googlelogin}>
          ...
          {success && (
            <div className="success-overlay">
              ...
              <h3 style={{fontFamily:'Cormorant Garamond', fontSize:'32px', fontWeight:300}}>You're in!</h3>
              <p style={{marginTop:'8px', fontSize:'14px', color:'var(--muted)'}}>Redirecting to your account…</p>
            </div>
          )}
        </div>
      </div>
